...
<?php if ($aprobado && $api_ok && $id_reserva): ?>
  ...
  <p style="font-size:28px;font-weight:800;color:#679938;margin:0 0 20px;">#<?php echo esc_html($id_reserva); ?></p>
...
<?php elseif ($aprobado && !$api_ok): ?>
  <div style="width:72px;height:72px;background:#FFF9E6;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 24px;font-size:32px;color:#D69E2E;">✓</div>
  <h2 style="font-size:22px;font-weight:700;color:#1A202C;margin:0 0 12px;">Pago recibido</h2>
  <p style="color:#596780;font-size:15px;line-height:1.7;margin:0 0 32px;">
    Tu seña fue procesada correctamente.<br>
    Estamos confirmando tu reserva y en breve<br>
    te enviaremos el número por email.<br>
