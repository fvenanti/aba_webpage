...
<html <?php language_attributes(); ?> class="no-js">
	<head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-26727917-1"></script>
		<script>
			window.dataLayer = window.dataLayer || [];
			function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());

			gtag('config', 'UA-26727917-1');
			gtag('config', 'AW-808820267');
		</script>

		<script>
			gtag('config', 'AW-808820267/3yjuCMGmluUBEKu81oED', {
				'phone_conversion_number': '+5492944604766'
			});
		</script>


		<script>
			gtag('config', 'AW-808820267/2ybnCPiwluUBEKu81oED', {
				'phone_conversion_number': '+542944461443'
			});
		</script>
